...
const AjouterStagiaires_byAdmins = () => {
  ...
  await axios.post('http://192.168.1.81:5000/Stagiaires/insert-from-csv', 
  dataWithoutHeader);
  } else {
  ...
  // Envoi de la requête si toutes les validations sont réussies
    axios
      .post("http://192.168.1.107:5000/Stagiaires/insert-from-form", {
        cef,
        nom_stagiaire,
        prenom_stagiaire,
        email,
...
export default AjouterStagiaires_byAdmins;