...
const CalendarStagiaires = () => {
  ...
  const fetchSeances = async () => {
    try {
      const response = await axios.get('http://192.168.1.81:5000/seances-stagiaires', {
        params: {
          id_stagiaire: 1, // Remplacez 123 par l'ID du stagiaire actuellement connecté
...
export default CalendarStagiaires;
